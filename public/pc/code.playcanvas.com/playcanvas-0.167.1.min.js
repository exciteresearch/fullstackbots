...
SHADOWUPDATE_NONE:0,SHADOWUPDATE_THISFRAME:1,SHADOWUPDATE_REALTIME:2};pc.extend(pc,e);pc.scene={};pc.extend(pc.scene,e)})();
...
{get:function(){return this._toneMapping},set:function(a){a!==this._toneMapping&&(this._toneMapping=a,this.updateShaders=!0)}});Object.defineProperty(e.prototype,"skybox",{get:function(){return this._skyboxCubeMap},set:function(a){this._skyboxCubeMap=a;this._skyboxModel&&this.containsModel(this._skyboxModel)&&this.removeModel(this._skyboxModel);this._skyboxModel=null;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxIntensity",{get:function(){return this._skyboxIntensity},set:function(a){this._skyboxIntensity=
a;this._skyboxModel=null;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxMip",{get:function(){return this._skyboxMip},set:function(a){this._skyboxMip=a;this._skyboxModel=null;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered128",{get:function(){return this._skyboxPrefiltered128},set:function(a){this._skyboxPrefiltered128=a;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered64",{get:function(){return this._skyboxPrefiltered64},
set:function(a){this._skyboxPrefiltered64=a;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered32",{get:function(){return this._skyboxPrefiltered32},set:function(a){this._skyboxPrefiltered32=a;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered16",{get:function(){return this._skyboxPrefiltered16},set:function(a){this._skyboxPrefiltered16=a;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered8",{get:function(){return this._skyboxPrefiltered8},
set:function(a){this._skyboxPrefiltered8=a;this.updateShaders=!0}});Object.defineProperty(e.prototype,"skyboxPrefiltered4",{get:function(){return this._skyboxPrefiltered4},set:function(a){this._skyboxPrefiltered4=a;this.updateShaders=!0}});e.prototype._updateShaders=function(a){var b;if(this._skyboxCubeMap&&!this._skyboxModel){var c=new pc.Material,d=this;c.updateShader=function(){var b=a.getProgramLibrary().getProgram("skybox",{rgbm:d._skyboxCubeMap.rgbm,hdr:d._skyboxCubeMap.rgbm||d._skyboxCubeMap.format===
pc.PIXELFORMAT_RGBA32F,useIntensity:1!==d.skyboxIntensity,mip:d.skyboxMip,fixSeams:d._skyboxCubeMap.fixCubemapSeams,gamma:d.gammaCorrection,toneMapping:d.toneMapping});this.setShader(b)};c.updateShader();d._skyboxMip?(b=this["skyboxPrefiltered"+[null,"64","16","8","4"][d._skyboxMip]])&&c.setParameter("texture_cubeMap",b):c.setParameter("texture_cubeMap",this._skyboxCubeMap);c.cull=pc.CULLFACE_NONE;b=new pc.GraphNode;var g=pc.createBox(a),c=new pc.MeshInstance(b,g,c),g=new pc.Model;g.graph=b;g.meshInstances=
[c];this._skyboxModel=g;this.addModel(g)}c=[];g=this.drawCalls;for(b=0;b<g.length;b++){var e=g[b];void 0!==e.material&&-1===c.indexOf(e.material)&&c.push(e.material)}for(b=0;b<c.length;b++)c[b].clearVariants(),c[b].updateShader(a,this),c[b].variants[0]=c[b].shader};e.prototype.getModels=function(){return this._models};e.prototype.addModel=function(a){var b;if(-1===this._models.indexOf(a)){this._models.push(a);var c=a.getMaterials();for(b=0;b<c.length;b++)c[b].scene=this;var d=a.meshInstances.length;
for(b=0;b<d;b++)c=a.meshInstances[b],-1===this.drawCalls.indexOf(c)&&this.drawCalls.push(c),c.castShadow&&-1===this.shadowCasters.indexOf(c)&&this.shadowCasters.push(c);a=a.getLights();b=0;for(len=a.length;b<len;b++)this.addLight(a[b])}};e.prototype.removeModel=function(a){var b,c=this._models.indexOf(a);if(-1!==c){this._models.splice(c,1);c=a.getMaterials();for(b=0;b<c.length;b++)c[b].scene=null;var d,g=a.meshInstances.length;for(b=0;b<g;b++)d=a.meshInstances[b],c=this.drawCalls.indexOf(d),-1!==
c&&this.drawCalls.splice(c,1),d.castShadow&&(c=this.shadowCasters.indexOf(d),-1!==c&&this.shadowCasters.splice(c,1));a=a.getLights();b=0;for(len=a.length;b<len;b++)this.removeLight(a[b])}};e.prototype.containsModel=function(a){return 0<=this._models.indexOf(a)};e.prototype.addLight=function(a){-1!==this._lights.indexOf(a)?console.warn("pc.Scene#addLight: light is already in the scene"):(this._lights.push(a),a._scene=this,this.updateShaders=!0)};e.prototype.removeLight=function(a){var b=this._lights.indexOf(a);
-1===b?console.warn("pc.Scene#removeLight: light is not in the scene"):(this._lights.splice(b,1),a._scene=null,this.updateShaders=!0)};e.prototype.update=function(){for(var a=0,b=this._models.length;a<b;a++)this._models[a].getGraph().syncHierarchy()};return{Scene:e}}());pc.extend(pc,function(){function e(a,b){return a.distSqr&&b.distSqr?b.distSqr-a.distSqr:b.key-a.key}function a(a,b){var c;if(b.getType()===pc.LIGHTTYPE_POINT){c=b._shadowResolution;c=new pc.Texture(a,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:c,height:c,cubemap:!0,autoMipmap:!1});c.minFilter=pc.FILTER_NEAREST;c.magFilter=pc.FILTER_NEAREST;c.addressU=pc.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.ADDRESS_CLAMP_TO_EDGE;for(var d=[],g=0;6>g;g++){var e=new pc.RenderTarget(a,c,{face:g,depth:!0});d.push(e)}c=d;b._shadowCamera.setRenderTarget(c[0]);
...
m.resolve(h+"_shadowParams").setValue([e._shadowResolution,e._normalOffsetBias,e._shadowBias]),this._activeShadowLights.push(e),0>this.mainLight&&(m.resolve(h+"_shadowMatrixVS").setValue(e._shadowMatrix.data),m.resolve(h+"_shadowParamsVS").setValue([e._shadowResolution,e._normalOffsetBias,e._shadowBias]),m.resolve(h+"_directionVS").setValue(e._direction.normalize().data),this.mainLight=g)),k++);return k},dispatchLocalLights:function(a,b,c){var d,e,g,f,h;d=a._localLights;var k=0;f=d[pc.LIGHTTYPE_POINT-
1];var m=d[pc.LIGHTTYPE_SPOT-1],l=f.length,n=m.length,r=this.device.scope;for(d=0;d<l;d++)f[d].mask&b&&(g=f[d],e=g._node.getWorldTransform(),h="light"+(c+k),r.resolve(h+"_radius").setValue(g._attenuationEnd),r.resolve(h+"_color").setValue(a.gammaCorrection?g._linearFinalColor.data:g._finalColor.data),e.getTranslation(g._position),r.resolve(h+"_position").setValue(g._position.data),g.getCastShadows()&&(e=this.device.extDepthTexture?g._shadowCamera._renderTarget._depthTexture:g._shadowCamera._renderTarget.colorBuffer,
r.resolve(h+"_shadowMap").setValue(e),r.resolve(h+"_shadowMatrix").setValue(g._shadowMatrix.data),r.resolve(h+"_shadowParams").setValue([g._shadowResolution,g._normalOffsetBias,g._shadowBias,1/g.getAttenuationEnd()]),this._activeShadowLights.push(g)),k++);for(d=0;d<n;d++)m[d].mask&b&&(f=m[d],e=f._node.getWorldTransform(),h="light"+(c+k),r.resolve(h+"_innerConeAngle").setValue(f._innerConeAngleCos),r.resolve(h+"_outerConeAngle").setValue(f._outerConeAngleCos),r.resolve(h+"_radius").setValue(f._attenuationEnd),
r.resolve(h+"_color").setValue(a.gammaCorrection?f._linearFinalColor.data:f._finalColor.data),e.getTranslation(f._position),r.resolve(h+"_position").setValue(f._position.data),e.getY(f._direction).scale(-1),r.resolve(h+"_spotDirection").setValue(f._direction.data),f.getCastShadows()&&(e=this.device.extDepthTexture?f._shadowCamera._renderTarget._depthTexture:f._shadowCamera._renderTarget.colorBuffer,r.resolve(h+"_shadowMap").setValue(e),r.resolve(h+"_shadowMatrix").setValue(f._shadowMatrix.data),r.resolve(h+
...
"skinInstance",{get:function(){return this._skinInstance},set:function(a){this._shaderDefs=(this._skinInstance=a)?this._shaderDefs|pc.SHADERDEF_SKIN:this._shaderDefs&~pc.SHADERDEF_SKIN;this._shader=null}});Object.defineProperty(a.prototype,"mask",{get:function(){return this._shaderDefs>>8},set:function(a){this._shaderDefs=this._shaderDefs&255|a<<8;this._shader=null}});pc.extend(a.prototype,{syncAabb:function(){},updateKey:function(){var a=this.material;this.key=(this.layer&7)<<28|(a.blendType&3)<<
...
c=a.settings.render.fog_color;this.scene.fogColor=new pc.Color(c[0],c[1],c[2]);this.scene.fogStart=a.settings.render.fog_start;this.scene.fogEnd=a.settings.render.fog_end;this.scene.fogDensity=a.settings.render.fog_density;this.scene.gammaCorrection=a.settings.render.gamma_correction;this.scene.toneMapping=a.settings.render.tonemapping;this.scene.exposure=a.settings.render.exposure;this.scene.skyboxIntensity=void 0===a.settings.render.skyboxIntensity?1:a.settings.render.skyboxIntensity;this.scene.skyboxMip=
void 0===a.settings.render.skyboxMip?0:a.settings.render.skyboxMip;a.settings.render.skybox&&((c=this.assets.getAssetById(a.settings.render.skybox))?(this._setSkybox(c.resources),c.on("change",this._onSkyBoxChanged,this),c.on("remove",this._onSkyBoxRemoved,this)):this.scene.skybox=null);b(a);this.loader.off("progress",d)}.bind(this),function(a){c(a)}).then(null,function(a){setTimeout(function(){throw a;},0)})}.bind(this),k=function(){var a=this.assets.list(e);this.loader.on("progress",d);a.length?
this.assets.load(a).then(function(a){f(a)}):setTimeout(function(){f([])},0)}.bind(this);if(this._librariesLoaded)k();else this.on("librariesloaded",function(){k()})},start:function(){if(this._librariesLoaded)this.tick();else this.on("librariesloaded",function(){this.tick()},this)},update:function(a){pc.ComponentSystem.fixedUpdate(1/60,this._inTools);pc.ComponentSystem.update(a,this._inTools);pc.ComponentSystem.postUpdate(a,this._inTools);this.fire("update",a);this.controller&&this.controller.update(a);
this.mouse&&this.mouse.update(a);this.keyboard&&this.keyboard.update(a);this.gamepads&&this.gamepads.update(a)},render:function(){var a=this.systems.camera.cameras,b=null,c=this.renderer;this.root.syncHierarchy();for(var d=0,e=a.length;d<e;d++)b=a[d],b.frameBegin(),c.render(this.scene,b.camera),b.frameEnd()},tick:function(){e._currentApplication=this;window.requestAnimationFrame(this.tick.bind(this));var a=window.performance&&window.performance.now?performance.now():Date.now(),b=(a-(this._time||a))/
1E3;this._time=a;b=pc.math.clamp(b,0,0.1);b*=this.timeScale;this.update(b);this.render()},setCanvasFillMode:function(a,b,c){this._fillMode=a;this.resizeCanvas(b,c)},setCanvasResolution:function(a,b,c){this._resolutionMode=a;a===pc.RESOLUTION_AUTO&&void 0===b&&(b=this.graphicsDevice.canvas.clientWidth,c=this.graphicsDevice.canvas.clientHeight);this.graphicsDevice.resizeCanvas(b,c)},isFullscreen:function(){return!!document.fullscreenElement},enableFullscreen:function(a,b,c){var a=a||this.graphicsDevice.canvas,
d=function(){b();document.removeEventListener("fullscreenchange",d)},e=function(){c();document.removeEventListener("fullscreenerror",e)};b&&document.addEventListener("fullscreenchange",d,!1);c&&document.addEventListener("fullscreenerror",e,!1);a.requestFullscreen(Element.ALLOW_KEYBOARD_INPUT)},disableFullscreen:function(a){var b=function(){a();document.removeEventListener("fullscreenchange",b)};a&&document.addEventListener("fullscreenchange",b,!1);document.exitFullscreen()},isHidden:function(){return document[this._hiddenAttr]},
onVisibilityChange:function(){this.isHidden()?this._audioManager.suspend():this._audioManager.resume()},resizeCanvas:function(a,b){var c=window.innerWidth,d=window.innerHeight;if(navigator.isCocoonJS)a=c,b=d,c=window.devicePixelRatio,this.graphicsDevice.resizeCanvas(a*c,b*c);else{if(this._fillMode===pc.FILLMODE_KEEP_ASPECT){var e=this.graphicsDevice.canvas.width/this.graphicsDevice.canvas.height;e>c/d?(a=c,b=a/e):(b=d,a=b*e)}else this._fillMode===pc.FILLMODE_FILL_WINDOW&&(a=c,b=d);this.graphicsDevice.canvas.style.width=
a+"px";this.graphicsDevice.canvas.style.height=b+"px";this._resolutionMode===pc.RESOLUTION_AUTO&&this.setCanvasResolution(pc.RESOLUTION_AUTO)}return{width:a,height:b}},onLibrariesLoaded:function(){this.systems.rigidbody.onLibraryLoaded();this.systems.collision.onLibraryLoaded()},_handleMessage:function(a){var b;switch(a.type){case pc.LiveLinkMessageType.UPDATE_COMPONENT:this._linkUpdateComponent(a.content.id,a.content.component,a.content.attribute,a.content.value);break;case pc.LiveLinkMessageType.UPDATE_ENTITY:this._linkUpdateEntity(a.content.id,
a.content.components);break;case pc.LiveLinkMessageType.UPDATE_ENTITY_TRANSFORM:this._linkUpdateEntityTransform(a.content.id,a.content.position,a.content.rotation,a.content.scale);break;case pc.LiveLinkMessageType.UPDATE_ENTITY_NAME:b=this.root.findOne("getGuid",a.content.id);b.setName(a.content.name);break;case pc.LiveLinkMessageType.UPDATE_ENTITY_ENABLED:b=this.root.findOne("getGuid",a.content.id);b.enabled=a.content.enabled;break;case pc.LiveLinkMessageType.REPARENT_ENTITY:this._linkReparentEntity(a.content.id,
a.content.newParentId,a.content.index);break;case pc.LiveLinkMessageType.CLOSE_ENTITY:if(b=this.root.findOne("getGuid",a.content.id))logDEBUG(pc.string.format("RT: Removed '{0}' from parent {1}",a.content.id,b.getParent().getGuid())),b.destroy();break;case pc.LiveLinkMessageType.OPEN_PACK:a=this.loader.open(pc.resources.PackRequest,a.content.pack);b=a.hierarchy;b.__parent?(a=this.root.findByGuid(b.__parent),a.addChild(b)):this.root.addChild(b);break;case pc.LiveLinkMessageType.OPEN_ENTITY:a.content.entity&&
...
A=k.getNumContacts(),y=[],u=[];if(0<A)if(g&pc.BODYFLAG_NORESPONSE_OBJECT||w&pc.BODYFLAG_NORESPONSE_OBJECT){var C=e.collision?e.collision.hasEvent("triggerenter")||e.collision.hasEvent("triggerleave"):!1,m=f.collision?f.collision.hasEvent("triggerenter")||f.collision.hasEvent("triggerleave"):!1;C&&(k=this._storeCollision(e,f))&&e.collision&&!(w&pc.BODYFLAG_NORESPONSE_OBJECT)&&e.collision.fire("triggerenter",f);m&&(k=this._storeCollision(f,e))&&f.collision&&!(g&pc.BODYFLAG_NORESPONSE_OBJECT)&&f.collision.fire("triggerenter",
e)}else if(C=e.collision?e.collision.hasEvent("collisionstart")||e.collision.hasEvent("collisionend")||e.collision.hasEvent("contact"):!1,m=f.collision?f.collision.hasEvent("collisionstart")||f.collision.hasEvent("collisionend")||f.collision.hasEvent("contact"):!1,(w=this.hasEvent("contact"))||C||m){for(g=0;g<A;g++){var H=k.getContactPoint(g),J=this._createContactPointFromAmmo(H),K=null;if(C||m)K=this._createReverseContactPointFromAmmo(H),y.push(J),u.push(K);w&&(H=this._createSingleContactResult(e,
f,J),this.fire("contact",H))}C&&(A=this._createContactResult(f,y),e.collision&&e.collision.fire("contact",A),(k=this._storeCollision(e,f))&&e.collision&&e.collision.fire("collisionstart",A));m&&(u=this._createContactResult(e,u),f.collision&&f.collision.fire("contact",u),(k=this._storeCollision(f,e))&&f.collision&&f.collision.fire("collisionstart",u))}}}this._cleanOldCollisions();this.contactPointPool.freeAll();this.contactResultPool.freeAll();this.singleContactResultPool.freeAll()}});return{RIGIDBODY_TYPE_STATIC:"static",
...
s.offset))}var h=new Uint16Array(h.lock()),n=m.primitive[0].count/3,l=new Ammo.btVector3,s=new Ammo.btVector3,B=new Ammo.btVector3,x,u,w=m.primitive[0].base,A=new Ammo.btTriangleMesh;for(f=0;f<n;f++)m=h[w+3*f]*r,x=h[w+3*f+1]*r,u=h[w+3*f+2]*r,l.setValue(v[m],v[m+1],v[m+2]),s.setValue(v[x],v[x+1],v[x+2]),B.setValue(v[u],v[u+1],v[u+2]),A.addTriangle(l,s,B,!0);f=new Ammo.btBvhTriangleMeshShape(A,!0);r=k.node.getWorldTransform().getScale();f.setLocalScaling(new Ammo.btVector3(r.x,r.y,r.z));r=k.node.getPosition();
...
h):null!==h&&void 0!==h&&(e[m.name]=h)}return this.addComponent(b,e)},onUpdate:function(a){var b=this.store,c,d,e;for(e in b)if(b.hasOwnProperty(e)){c=b[e];var f=c.entity;c=c.data;if(c.enabled&&f.enabled&&(f=c.model.emitter,!c.paused&&(f.simTime+=a,c=0,f.simTime>f.fixedTimeStep&&(c=Math.floor(f.simTime/f.fixedTimeStep),f.simTime-=c*f.fixedTimeStep),c))){c=Math.min(c,f.maxSubSteps);for(d=0;d<c;d++)f.addTime(f.fixedTimeStep)}}},onToolsUpdate:function(){var a=this.store,b;for(b in a)if(a.hasOwnProperty(b)){var c=
a[b];c.data.enabled&&c.entity.enabled&&this._updateDebugShape(c)}},onRemove:function(a,b){b.model&&(this.app.scene.removeModel(b.model),a.removeChild(b.model.getGraph()),b.model=null)},_createDebugMesh:function(){var a=this.app.graphicsDevice,b=new pc.VertexFormat(a,[{semantic:pc.SEMANTIC_POSITION,components:3,type:pc.ELEMENTTYPE_FLOAT32}]),b=new pc.VertexBuffer(a,b,8);(new Float32Array(b.lock())).set([-0.5,-0.5,-0.5,-0.5,-0.5,0.5,0.5,-0.5,0.5,0.5,-0.5,-0.5,-0.5,0.5,-0.5,-0.5,0.5,0.5,0.5,0.5,0.5,
0.5,0.5,-0.5]);b.unlock();a=new pc.IndexBuffer(a,pc.INDEXFORMAT_UINT8,24);(new Uint8Array(a.lock())).set([0,1,1,2,2,3,3,0,4,5,5,6,6,7,7,4,0,4,1,5,2,6,3,7]);a.unlock();var c=new pc.Mesh;c.vertexBuffer=b;c.indexBuffer[0]=a;c.primitive[0].type=pc.PRIMITIVE_LINES;c.primitive[0].base=0;c.primitive[0].count=a.getNumIndices();c.primitive[0].indexed=!0;return c},_createDebugShape:function(a){var b=new pc.GraphNode,c=new pc.Model;c.graph=b;c.meshInstances=[new pc.MeshInstance(b,this.debugMesh,this.debugMaterial)];
a.data.debugShape=c;a.data.enabled&&a.entity.enabled&&(this.app.root.addChild(b),this.app.scene.addModel(c));return c},_updateDebugShape:function(a){var b=a.data.emitterExtents,c=b.x,d=b.y,b=b.z,e=a.entity,a=a.data.debugShape.graph;a.setPosition(e.getPosition());a.setRotation(e.getRotation());a.setLocalScale(c||5E-4,d||5E-4,b||5E-4)}});return{ParticleSystemComponentSystem:e}}());pc.extend(pc,function(){var e="emitterExtents emitterRadius colorMap normalMap loop initialVelocity".split(" "),a="numParticles lifetime rate rate2 startAngle startAngle2 lighting halfLambert intensity wrap wrapBounds depthWrite depthSoftening sort stretch alignToMotion preWarm emitterShape".split(" "),b="scaleGraph scaleGraph2 colorGraph colorGraph2 alphaGraph alphaGraph2 velocityGraph velocityGraph2 localVelocityGraph localVelocityGraph2 rotationSpeedGraph rotationSpeedGraph2".split(" "),c=function(){this.on("set_colorMapAsset",

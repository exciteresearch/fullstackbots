...
//                    } else {
//                        myPath=path;
//                        if(logging===true){console.log("New path set to this destination: ",myPath[myPath.length-1])}
//                        if(logging===true){console.log("This is the first step of th path: ",myPath[0])}
//                    }
//                });
//                easystar.calculate();
...
//            if(this.pastLocations.length>190){
...
//                this.unstick--
//            }else{
//                if(Math.abs(this.pastLocations[0]-this.pastLocations[88])+Math.abs(this.pastLocations[1]-this.pastLocations[89])+Math.abs(this.pastLocations[0]-this.pastLocations[188])+Math.abs(this.pastLocations[1]-this.pastLocations[189])<0.05){
//                    this.movementOne=Math.round(Math.random()*2-1)
//                    this.movementTwo=Math.round(Math.random()*2-1)
//                    this.unstick=0;
//                    if(logging===true){console.log("this: ",this.pastLocations[0], this.pastLocations.length)}
//                    currentPriority=0;
//                    if(logging===true){console.log(this.name+" attempting to get move out of a corner.")}
//                }else{
//                    //Pathing:
...
//                       l=0;
//                       currentPriority=0;
//                       if(logging===true){console.log(this.name+" made it to destination.")}
//                    }
//                    if(this.destination===true&&myPath.length>0){
//        
//                        if (Math.abs(this.tankPosition[0]-(myPath[l].x))+Math.abs(this.tankPosition[2]-(myPath[l].y))<0.75){ 
//                            if(logging===true){console.log(this.name+" following path to destination. Next:")}
//                            l++; 
//                        }
...
//                            if(logging===true){console.log("heading east", this.movementOne, this.movementTwo, "tankPositon: ", this.tankPosition[0], this.tankPosition[2]);}
//                        }
//                        if (this.tankPosition[0]>myPath[l].x&&this.tankPosition[2]<myPath[l].y){
//                            
//                            this.movementOne=-1
//                            this.movementTwo=(((Math.abs(this.tankPosition[2]-myPath[l].y)/(Math.abs(this.tankPosition[0]-myPath[l].x)+Math.abs(this.tankPosition[2]-myPath[l].y)))*2)-1)
//                            if(logging===true){console.log("heading west", this.movementOne, this.movementTwo, "tankPositon: ", this.tankPosition[0], this.tankPosition[2]);}
//                        }
//                        if(this.tankPosition[0]>myPath[l].x&&this.tankPosition[2]>myPath[l].y){
//                            
//                           this.movementTwo=-1
...
//                            if(logging===true){console.log("heading north", this.movementOne, this.movementTwo, "tankPositon: ", this.tankPosition[0], this.tankPosition[2]);}
//                        }
//                        if(this.tankPosition[0]<myPath[l].x&&this.tankPosition[2]<myPath[l].y){
//                            
//                           this.movementTwo=1
//                           this.movementOne=(((Math.abs(this.tankPosition[0]-myPath[l].x)/(Math.abs(this.tankPosition[0]-myPath[l].x)+Math.abs(this.tankPosition[2]-myPath[l].y)))*2)-1)
//                            if(logging===true){console.log("heading south", this.movementOne, this.movementTwo, "tankPositon: ", this.tankPosition[0], this.tankPosition[2]);}
//                        }
//                    }else{
//                    
//                        if (! this.connected)
